  ...
  module Builtin
    class TestSetInternalByte < BootTest
      ...
      def test_all
        ...
        assert_slot_to_reg 10 ,:message , 6 , "message.caller"
        assert_reg_to_slot 11 , "message.return_value" , "message.caller" , 5
        assert_branch 12 , "return_label"
        assert_label 13 , "return_label"
      end
      def test_return
        assert_return(13)
      end
